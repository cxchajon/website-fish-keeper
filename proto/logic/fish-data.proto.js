...
import { validateSpeciesRecord } from "./speciesSchema.proto.js";
...
export const FISH_DB = [
  ...
  { id:"dgourami", common_name:"Dwarf Gourami", scientific_name:"Trichogaster lalius", category:"fish",
    ...
    aggression:30, tags:["labyrinth","fin_sensitive"], invert_safe:false, mouth_size_in:0.3, bioloadGE:2.0 },
  { id:"pgourami", common_name:"Pearl Gourami", scientific_name:"Trichopodus leerii", category:"fish",
    ...
    aggression:20, tags:["labyrinth","fin_sensitive"], group:{type:"harem",min:3,ratio:{m:1,f:2}}, invert_safe:false, mouth_size_in:0.5, bioloadGE:4.0 },
  { id:"cardinal", common_name:"Cardinal Tetra", scientific_name:"Paracheirodon axelrodi", category:"fish",
    ...
    aggression:5, tags:["shoaler","fin_sensitive","nano"], group:{type:"shoal",min:6}, invert_safe:false, mouth_size_in:0.15, ph_sensitive:true, bioloadGE:0.6 },
  ...
  { id:"harlequin", common_name:"Harlequin Rasbora", scientific_name:"Trigonostigma heteromorpha", category:"fish",
    ...
    aggression:5, tags:["shoaler"], group:{type:"shoal",min:6}, invert_safe:false, mouth_size_in:0.2, bioloadGE:0.5 },
  ...
  { id:"cherrybarb", common_name:"Cherry Barb", scientific_name:"Puntius titteya", category:"fish",
    ...
    aggression:10, tags:["shoaler"], group:{type:"shoal",min:6}, invert_safe:false, mouth_size_in:0.2, bioloadGE:0.6 },
  { id:"zebra", common_name:"Zebra Danio", scientific_name:"Danio rerio", category:"fish",
    ...
    gH:{min_dGH:5,max_dGH:19}, kH:{min_dKH:4,max_dKH:15}, salinity:"fresh", flow:"high", blackwater:"neutral",
    aggression:15, tags:["shoaler","fast_swimmer","fin_nipper"], group:{type:"shoal",min:6}, invert_safe:false, mouth_size_in:0.2, bioloadGE:0.7 },
  { id:"cory_panda", common_name:"Panda Corydoras", scientific_name:"Corydoras panda", category:"fish",
    ...
    aggression:0, tags:["shoaler","bottom_dweller","invert_safe"], group:{type:"shoal",min:5}, invert_safe:true, mouth_size_in:0.1, bioloadGE:1.0 },
  { id:"cory_bronze", common_name:"Bronze Corydoras", scientific_name:"Corydoras aeneus", category:"fish",
    ...
    aggression:0, tags:["shoaler","bottom_dweller","invert_safe"], group:{type:"shoal",min:5}, invert_safe:true, mouth_size_in:0.15, bioloadGE:1.2 },
  { id:"kuhli", common_name:"Kuhli Loach", scientific_name:"Pangio kuhlii", category:"fish",
    ...
    aggression:0, tags:["shoaler","bottom_dweller","nocturnal","invert_safe"], group:{type:"shoal",min:5}, invert_safe:true, mouth_size_in:0.1, bioloadGE:0.8 },
  { id:"otocinclus", common_name:"Otocinclus (Oto Cat)", scientific_name:"Otocinclus spp.", category:"fish",
    ...
    gH:{min_dGH:5,max_dGH:15}, kH:{min_dKH:2,max_dKH:10}, salinity:"fresh", flow:"moderate", blackwater:"neutral",
    aggression:0, tags:["shoaler","bottom_dweller","algae_specialist","invert_safe"], group:{type:"shoal",min:5}, invert_safe:true, bioloadGE:0.4 },
  { id:"amano", common_name:"Amano Shrimp", scientific_name:"Caridina multidentata", category:"shrimp",
    ...
    aggression:0, tags:["algae_specialist","invert_safe"], invert_safe:true, bioloadGE:0.12 },
  { id:"neocaridina", common_name:"Cherry Shrimp", scientific_name:"Neocaridina davidi", category:"shrimp",
    ...
    aggression:0, tags:["invert_safe"], invert_safe:true, ph_sensitive:true, bioloadGE:0.08 },
  { id:"nerite", common_name:"Nerite Snail", scientific_name:"Neritina spp.", category:"snail",
    ...
    aggression:0, tags:["algae_specialist","invert_safe"], invert_safe:true, bioloadGE:0.25 },
  { id:"guppy_male", common_name:"Guppy (Male)", scientific_name:"Poecilia reticulata", category:"fish",
    ...
    aggression:10, tags:["livebearer","fin_sensitive"], invert_safe:false, mouth_size_in:0.15, bioloadGE:0.5 }
];
