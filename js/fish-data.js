...
window.FISH_DATA = [
  ...
  // sensitive: slightly tighter (soft/acidic specialist)
  { id:"cardinal_tetra",    name:"Cardinal tetra",                points:1.2, min:6,  temp:[78,81], ph:[5.0,6.6], sensitive:true },
  { id:"ember_tetra",       name:"Ember tetra",                   points:0.9, min:8,  temp:[73,82], ph:[5.5,7.0] },
  // sensitive: notably tighter
  { id:"rummynose_tetra",   name:"Rummy-nose tetra",              points:1.4, min:8,  temp:[78,80], ph:[5.2,6.6], sensitive:true },
  ...
  // sensitive: cooler/oxygenated; narrower
  { id:"cory_panda",        name:"Corydoras panda",               points:2.4, min:6,  temp:[70,75], ph:[6.2,7.2], sensitive:true },
  // sensitive: shy/stress-prone; narrower
  { id:"kuhli_loach",       name:"Kuhli loach",                   points:2.5, min:5,  temp:[77,80], ph:[5.8,6.8], sensitive:true },
  // sensitive: delicate algae grazers; narrower
  { id:"otocinclus",        name:"Otocinclus",                    points:1.2, min:6,  temp:[74,80], ph:[6.2,7.2], sensitive:true },
  ...
  // sensitive: blackwater dwarf cichlid; narrower
  { id:"apistogramma",      name:"Apistogramma (pair)",           points:6.0, min:1,  temp:[78,82], ph:[5.2,6.6], sensitive:true },
  // sensitive: very warm, soft/acidic; narrower
  { id:"ram_cichlid",       name:"Ram cichlid (German blue)",     points:5.0, min:1,  temp:[80,82], ph:[5.5,6.5], sensitive:true },
