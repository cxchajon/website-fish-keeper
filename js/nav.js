(() => {
  ...
  function toCanonicalPath(path) {
    ...
    const map = {
      ...
      '/feature-your-tank': '/submit-your-tank.html',
      '/feature-your-tank.html': '/submit-your-tank.html',
      '/submit-your-tank': '/submit-your-tank.html',
      '/submit-your-tank.html': '/submit-your-tank.html',
      '/community-tanks': '/community-tanks.html',
      '/community-tanks.html': '/community-tanks.html',
      '/podcast': '/podcast/',
      '/podcast/': '/podcast/',
      '/tank-guide-life': '/podcast/',
      '/tank-guide-life/': '/podcast/',
